       ...
       ZStack {
         VStack{
           ScrollView{
             ...
             .padding(.top)
         VStack{
            MainLeftListItem1(headTitle: leftListHeadTitle[0], icon: leftListHeadTitleIcon[0],isTeacher: true).padding(.vertical,-3)
            MainLeftListItem1(headTitle: leftListHeadTitle[1], icon: leftListHeadTitleIcon[1],isTeacher: true).padding(.vertical,-3)
            MainLeftListItem1(headTitle: leftListHeadTitle[2], icon: leftListHeadTitleIcon[2],isTeacher: true).padding(.vertical,-3)
            MainLeftListItem1(headTitle: leftListHeadTitle[3], icon: leftListHeadTitleIcon[3],isTeacher: true).padding(.vertical,-3)
            MainLeftListItem1(headTitle: leftListHeadTitle[4], icon: leftListHeadTitleIcon[4],isTeacher: true).padding(.vertical,-3)
               ...
               .ignoresSafeArea(.all)
                ...
                VStack(alignment: .leading){
                    ...
                    whichView1(index: data.pageIndex).environmentObject(data).padding()
...
func whichView1(index:Int) -> AnyView {
    switch (index){
    case 11 : return AnyView(teacherMain())
    case 22 : return AnyView(teacherAttendance())
    case 33 : return AnyView(allTeacher())
    case 44 : return AnyView(teacherExam())
    case 55 : return AnyView(allTeacher())
    default :
        print ("no avialable index")
        return AnyView(teacherMainPage())
        
    }
}


struct teacherMainPage_Previews: PreviewProvider {
    static var previews: some View {
        teacherMainPage()
    }
}
struct MainLeftListItem1:View{
    @State var headTitle:String
    @State var icon:String
    @State var isTeacher:Bool
